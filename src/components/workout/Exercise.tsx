...
import { Theme, withStyles, WithStyles, Box, IconButton, Grid, Typography } from '@material-ui/core'
...
function Exercise(props: ExerciseProps & WithStyles<'title' | 'item' | 'iconButton'>) {
    return (
